...
class GameConfig:
    ...
    def get(self, *keys, default=None):
        """
        链式取值
        用法: game_config.get("meditation", "base_min", default=10)
        """
        data = self._data
        for k in keys:
    ...
    def level_map(self) -> Dict[int, int]:
        ...
        return {1: 0, 2: 100, 3: 800, 4: 2000, 5: 5000, 6: 15000, 7: 40000}
    ...
    def level_titles(self) -> Dict[int, str]:
        ...
        return {
            1: "灵识觉醒", 2: "聚灵化息", 3: "引灵归宗",
            4: "固灵成相", 5: "御灵镇域", 6: "化灵通神", 7: "万灵归一"
        }
    ...
    def fortune_mults(self) -> Dict[str, float]:
        return self.get("fortune", "mults", default={
            "大吉": 0.5, "中吉": 0.2, "小吉": 0.1, "平": 0.0, "末凶": -0.1
        })
    ...
    def expedition_locations(self) -> Dict[str, Any]:
        return self.get("expedition", "locations", default={
            "灵溪周边": {"level": 2, "time": 3600, "sp_min": 5, "sp_max": 5, "drops": {"神秘种子": 0.3}},
        })
    ...
    def garden_plants(self) -> Dict[str, str]:
        return self.get("garden", "plants", default={
            "灵心草": "下一次聚灵收益+50%",
            "鸾草": "下一次鉴定必出华丽词条",
            "蓝玉果": "下一次聚灵必出最大值",
            "凤羽花": "下一次派遣必带回法宝碎片",
    ...
    def garden_growth(self) -> Dict[str, int]:
        return self.get("garden", "growth", default={
            "seed_to_sprout": 1,
            "sprout_to_growing": 2,
            "growing_to_mature": 5,
        })
    ...
    def garden_icons(self) -> Dict[str, str]:
        return self.get("garden", "icons", default={
            "empty": "🟫", "seed": "🌰", "sprout": "🌱",
            "growing": "🌿", "mature": "🍎",
        })
    ...
    def buff_pool(self) -> List[Dict[str, str]]:
        return self.get("resonance", "buff_pool", default=[
    ...
    def buff_pool_rare(self) -> List[Dict[str, str]]:
        return self.get("resonance", "buff_pool_rare", default=[
    ...
    def random_chat_min_length(self) -> int:
        return self.get("security", "random_chat_min_length", default=4)
